...
public class ExportRuneTileEntityRenderer extends TileEntityRenderer<ExportRuneTile>{
    ...
    public void render(ExportRuneTile te, float partialTicks, MatrixStack matrixStackIn,
        ...
        {if(te.getBlockState().toString().contains("down")) {
            ...
            //renderItem(te.getItem(), new double[] {0.5d, h, 0.5d}, Vector3f.YP.rotationDegrees(r1+45), Vector3f.XP.rotationDegrees(0),
        ...
        matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, (float) (((0.5-((float) h))*4)*d));
            ...
            //renderItem(te.getItem(), new double[] {0.5d, h, 0.5d}, Vector3f.YP.rotationDegrees(45-r1), Vector3f.XP.rotationDegrees(180),
            //matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, 0.4f);
        ...
        matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, (float) (((0.5-((float) h))*4)*d));
            ...
            //renderItem(te.getItem(), new double[] {0.5d, 0.5d, h}, Vector3f.ZP.rotationDegrees(r1+45), Vector3f.XP.rotationDegrees(90),
            //matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, 0.4f);
        ...
        matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, (float) (((0.5-((float) h))*4)*d));
            ...
            //renderItem(te.getItem(), new double[] {0.5d, 0.5d, h}, Vector3f.ZP.rotationDegrees(45-r1), Vector3f.XP.rotationDegrees(-90),
            //matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, 0.4f);
        ...
        matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, (float) (((0.5-((float) h))*4)*d));
            ...
            //renderItem(te.getItem(), new double[] {h, 0.5d, 0.5d}, Vector3f.XP.rotationDegrees(r1+45), Vector3f.ZP.rotationDegrees(90),
            //matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, 0.4f);
        ...
        matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, (float) (((0.5-((float) h))*4)*d));
            ...
            //renderItem(te.getItem(), new double[] {h, 0.5d, 0.5d}, Vector3f.XP.rotationDegrees(45-r1), Vector3f.ZP.rotationDegrees(-90),
            //matrixStackIn, bufferIn, partialTicks, combinedOverlayIn, lightLevel, 0.4f);
